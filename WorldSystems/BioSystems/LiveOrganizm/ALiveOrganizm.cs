...
namespace WorldSystems.BioSystems.LiveOrganizm
{
    public abstract class ALiveOrganizm : ILiveOrganizm
    {
        ...
        /// <summary>
        /// * энергетическая – все внутриклеточные процесы идут с затратой энергии,
        /// основным поставщиком энергии в клетке являются митохондрии
        /// </summary>
        public abstract void EnergyFunc();
        /// <summary>
        /// * метаболизм или обмен вещ-в – физиологические процессы.
        /// Питание через эндоцитоз (пиноцитоз и фагоцитоз)
        /// </summary>
        public abstract void MetabolismFunc();
        /// <summary>
        /// * барьерно-рецепторная. На плазмолемме локализованы спец структуры,
        /// участвующие в узнавании хим и физ факторов, обладает большим набором
        /// рецепторов – чувствительные участки
        /// </summary>
        /// <remarks></remarks>
        public abstract void BarrierReceptor();
        /// <summary>
        /// * транспортная – пассивный перенос ряда веществ, активный перенос с
        /// затратой энергии.
        /// </summary>
        public abstract void TransportFunc();
        /// <summary>
        /// * регуляторная функция - согласует работу синтетическоо аппарата и
        /// энергетических органелл, контролирует обмен вещ-в
        /// </summary>
